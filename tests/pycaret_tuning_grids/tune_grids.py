PYCARET_REGRESSION_TUNE_GRIDS = {
    ...
    "llar": {
        ...
        # Whether to copy X
        "copy_X": [True, False],
        # Precision for stopping
        "eps": [1e-10, 1e-8, 1e-6], 
        # Calculate intercept or not
        "fit_intercept": [True, False],
        # Compute full coefficient path
        "fit_path": [True, False],
        # Stabilization jitter
        "jitter": [1e-6, 1e-5, 1e-4],
        # Maximum iterations
        "max_iter": [500, 1000, 2000],
        # Restrict coefficients to be positive
        "positive": [True, False],
    ...
    "dummy": {  # Dummy Regressor
        # DummyRegressor, almost nothing to tune:
